...
class ProjectControllerTest {
    ...
    void setUp() {
        ...
        admin      = new User(1L, "admin", "1234", AccountStatus.ACTIVE, Role.ADMIN);
        normalUser = new User(2L, "dev1",  "1234", AccountStatus.ACTIVE, Role.DEVELOPER);
    }
    ...
    void addMemberShouldNotAddDuplicates() {
        ...
        projectController.addMemberToProject(project, normalUser, admin);
        projectController.addMemberToProject(project, normalUser, admin); // 중복
